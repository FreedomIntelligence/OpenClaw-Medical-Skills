...
```python
# Read with filtering
gdf = gpd.Read("data.gpkg", bbox=(xmin, ymin, xmax, ymax))
...
roads = gpd.Read("roads.shp")
buildings = gpd.Read("buildings.geojson")
